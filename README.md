...
4. 이벤트 핸들링이 손쉽다. (별도의 메서드 선언없이 Anonymous Method지원, Coroutine지원)
...
Lastest Release
---
Version(Alpha) 0.0.54 - [XTween_0.0.54.unitypackage](https://github.com/Toki-Labs/XTween/raw/master/Bin/XTween_0.0.54.unitypackage)
